...
QA_PATTERNS = [
    ...
    },
    {
        ...
        "patterns": [r"お?金.{0,3}(ない|無い|足り|なくな)", r"金欠"],
        "response": "毎週月曜日にお金を郵送してるよ！\n届いたらメモしながら1週間で計画的に使ってね。\n月曜日にポストを確認してみて",
    },
    {
        "id": "nomura",
        "keywords": ["野村", "証券", "のむら"],
    ...
    },
    {
        ...
        "patterns": [r"(送って|おくって|振り込|振込)", r"いくらか", r"(お?金|おかね).{0,3}(くれ|ちょうだい|ほしい|欲しい)"],
        "response": "毎週月曜日にお金を送ってるよ。",
    },
    {
        "id": "payment",
